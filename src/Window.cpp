...
tuple<vector<ColorVertex>, vector<uint16_t>> makeBox(){
    // TimeGuard tg("create box");
    ...
    */
    ...
    const auto numVertices=std::min(
    ...
    // vector<ColorVertex> vertices(numVertices);
